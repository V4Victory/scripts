...
public class InteractNPC extends Task {

	Value<NPC> object;
	String interaction;

	public InteractNPC(Condition c, State s,
			final Value<NPC> object_, String interaction_) {
		this(c, s, object_, interaction_, false);
	}

	public InteractNPC(final Condition c, State s,
			final Value<NPC> object_, String interaction_,
