...
public class Product {
		...
		public void run(final Product p) {
			...
			waitFor(new Condition() {
				public boolean validate() {
					...
					Time.sleep(700);
					// 3021, 5808, 4965
					NPC leprechaun = NPCs.getNearest(7569, 3021, 5808, 7557,
							4965);
					if (leprechaun == null) {
						Camera.setAngle((540 - Camera.getYaw()) % 360);
						leprechaun = NPCs.getNearest(7569, 3021, 5808, 7557,
								4965);
					}
					if (leprechaun != null) {
	...
	private static HashMap<Integer, Product> loadProducts() {
		...
		Product[] productsPlain = {
				...
				new Product(24155, "Double spin ticket", new Interact(
						"Claim spin")),
				...
				new Product(201, "Grimy Marrentil", Drop, GiveToLeprechaun,
						Clean),
				new Product(251, "Clean Marrentil", Drop, GiveToLeprechaun),
				new Product(203, "Grimy Tarromin", Drop, GiveToLeprechaun,
						Clean),
				new Product(253, "Clean Tarromin", Drop, GiveToLeprechaun),
				new Product(205, "Grimy Harralander", Drop, GiveToLeprechaun,
						Clean),
				...
				new Product(2998, "Grimy Toadflax", Drop, GiveToLeprechaun,
						Clean),
				...
				new Product(14836, "Grimy Wergali", Drop, GiveToLeprechaun,
						Clean),
				...
				new Product(3051, "Grimy Snapdragon", Drop, GiveToLeprechaun,
						Clean),
				new Product(3000, "Clean Snapdragon", Drop, GiveToLeprechaun),
				new Product(215, "Grimy Cadantine", Drop, GiveToLeprechaun,
						Clean),
				new Product(265, "Clean Cadantine", Drop, GiveToLeprechaun),
				new Product(2485, "Grimy Lantadyme", Drop, GiveToLeprechaun,
						Clean),
				new Product(2481, "Clean Lantadyme", Drop, GiveToLeprechaun),
				new Product(217, "Grimy Dwarf weed", Drop, GiveToLeprechaun,
						Clean),
				new Product(267, "Clean Dwarf weed", Drop, GiveToLeprechaun),
				new Product(12174, "Grimy Spirit weed", Drop, GiveToLeprechaun,
						Clean),
				...
				new Product(21626, "Grimy Fellstalk", Drop, GiveToLeprechaun,
						Clean),
